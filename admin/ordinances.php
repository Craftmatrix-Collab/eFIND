...
if (!empty($search_query)) {
    ...
    $searchFields = [
        ...
        "COALESCE(ordinance_number, '') LIKE ?",
        "COALESCE(date_posted, '') LIKE ?",
        "COALESCE(ordinance_date, '') LIKE ?",
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="search-box">
                            ...
                            <input type="text" name="search_query" id="searchInput" class="form-control" placeholder="Search any ordinance field (title, number, status, content, uploader, etc.)..." value="<?php echo htmlspecialchars($search_query); ?>">
                        </div>
                    </div>
                    <div class="col-md-1">
