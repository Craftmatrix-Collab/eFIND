...
$chatbot_profile_picture_path = efind_resolve_profile_picture_src($_SESSION['profile_picture'] ?? '');
?>
...
const chatbotUserId = '<?php echo isset($_SESSION["admin_id"]) ? $_SESSION["admin_id"] : (isset($_SESSION["user_id"]) ? $_SESSION["user_id"] : "guest"); ?>';
