...
if (isset($_GET['print']) && $_GET['print'] === '1') {
    ...
    $printParams = [];
    $printTypes = '';
    appendPrintDateRangeConditions('resolution_date', $printStartDate, $printEndDate, $printConditions, $printParams, $printTypes);
                ...
                <div class="row g-2">
                    <div class="col-lg-7 col-md-6 col-12">
                        <div class="search-box">
                            ...
                            <input type="text" name="search_query" id="searchInput" class="form-control" placeholder="Search any resolution field (title, number, content, etc.)..." value="<?php echo htmlspecialchars($search_query); ?>">
                        </div>
                    </div>
...
<\/script>
            ...
            bindDragDropUploadZone('resAddFileUploadZone', 'image_file', async function(input, options) {
                await processFilesWithAutoFill(input, options);
            });
            bindDragDropUploadZone('resEditFileUploadZone', 'editImageFile', async function(input, options) {
